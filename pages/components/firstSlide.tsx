      ...
      <div className="firstSlide">
            ...
            <div className="firstSlideContent">
                <div className="imageContainer">
                    <Image className="tharunoptimusImage" src="/assets/images/pics/tharunoptimus.png" alt="Tharunraj Mailvakanan" width={160} height={160} />
                </div>
        ...
        <style jsx>{`
            ...
            .firstSlideBackground {
                ...
                background: url(/assets/images/svg/first.svg) no-repeat center center;
